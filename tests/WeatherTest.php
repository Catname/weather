 ...
 */
namespace Catname\Weather\Tests;

use Catname\Weather\Exceptions\HttpException;
use Catname\Weather\Exceptions\InvalidArgumentException;
use Catname\Weather\Weather;
